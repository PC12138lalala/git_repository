...
function change(year, type) {
    ...
    if (type == "#c_e") {
        ...
        $(type).append("<div class='big_img'><img src='img/photo/" + a.getElementsByTagName("entity")[0].getElementsByTagName("photo")[0].text + "' alt='' ><span>" + a.getElementsByTagName("entity")[0].getElementsByTagName("designation")[0].text + "</span></div>");
        for (var i = 1; i < (a.getElementsByTagName("entity").length > 4 ? 4 : a.getElementsByTagName("entity").length); i++)
            $(type).append("<div class='small_img'><img src='img/photo/" + now.getElementsByTagName("community")[0].getElementsByTagName("entity")[i].getElementsByTagName("photo")[0].text + "' alt=''></div>");
    } else {
        var a = now.getElementsByTagName("individual")[0];
        $("#i_e").append("<div class='big_img'><img src='img/photo/" + a.getElementsByTagName("entity")[0].getElementsByTagName("photo")[0].text + "' alt='' ><span>" + a.getElementsByTagName("entity")[0].getElementsByTagName("name")[0].text + "</span></div>");
        for (var i = 1; i < (a.getElementsByTagName("entity").length > 4 ? 4 : a.getElementsByTagName("entity").length); i++)
            $("#i_e").append("<div class='small_img'><img src='img/photo/" + now.getElementsByTagName("individual")[0].getElementsByTagName("entity")[i].getElementsByTagName("photo")[0].text + "' alt=''></div>");
    }
