...
<html>
  ...
  <h1>User Info</h1>
    <%
     ...
     <div id="pageing">
     	<left>
     		<button id="pre" onclick="window.location.href='manage/user?target=user&current=${pageing.current -1}'">pre</button>
     		<span id="span"></span>
     		<button id="next" onclick="window.location.href='manage/user?target=user&current=${pageing.current+1}'" >next</button>
