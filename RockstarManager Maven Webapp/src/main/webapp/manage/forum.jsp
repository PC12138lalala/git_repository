...
<html>
  ...
  <body>
    ...
    if(forum!=null)
     ...
     <div id="pageing">
     	<left>
     		<button id="pre" onclick="window.location.href='manage/forum?target=forum&current=${pageing.current -1}'">pre</button>
     		<span id="span"></span>
     		<button id="next" onclick="window.location.href='manage/forum?target=forum&current=${pageing.current+1}'" >next</button>
