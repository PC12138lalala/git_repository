...
<html>
  ...
  <body>
    <h1>News Manager</h1>
    <form action="manage/addNews" method="post" enctype="multipart/form-data" onsubmit="return check()">
     ...
     <div id="pageing">
     	<left>
     		<button id="pre" onclick="window.location.href='manage/news?target=news&current=${pageing.current -1}'">pre</button>
     		<span id="span"></span>
     		<button id="next" onclick="window.location.href='manage/news?target=news&current=${pageing.current+1}'" >next</button>
