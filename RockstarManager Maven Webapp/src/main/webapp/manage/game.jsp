...
<html>
  ...
  <body>
  <h1>Game Info</h1>
  	<form action="manage/addGame" method="post" onsubmit="return check()" enctype="multipart/form-data">
    ...
    <%
     ...
     <div id="pageing">
     	<left>
     		<button id="pre" onclick="window.location.href='manage/game?target=game&current=${pageing.current -1}'">pre</button>
     		<span id="span"></span>
     		<button id="next" onclick="window.location.href='manage/game?target=game&current=${pageing.current+1}'" >next</button>
