...
<html>
  ...
  <body>
    <h1>Video Info</h1>
    <form action="manager/addVideo" method="post" onsubmit="return check()" enctype="multipart/form-data">
     ...
     <div id="pageing">
     	<left>
     		<button id="pre" onclick="window.location.href='manager/video?target=video&current=${pageing.current -1}'">pre</button>
     		<span id="span"></span>
     		<button id="next" onclick="window.location.href='manager/video?target=video&current=${pageing.current+1}'" >next</button>
